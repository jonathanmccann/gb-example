...
#define first_straight_shot 5
#define first_upper_shot 6
#define first_lower_shot 7
#define second_straight_shot 8
#define second_upper_shot 9
#define second_lower_shot 10
#define third_straight_shot 11
#define third_upper_shot 12
#define third_lower_shot 13

// Define the starting index of the shot sprites
// for use inside of the loop in 'player.c'
#define shot_sprite_starting_position 5
